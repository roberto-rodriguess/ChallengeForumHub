package org.api.challengeforumhub.infra.exception;
...
public class TratadorDeErros {
    ...
    public ResponseEntity<Map<String, Object>> tratarErro404(WebRequest request) {
        Map<String, Object> body = new HashMap<>();
        body.put("status", HttpStatus.NOT_FOUND.value());
        body.put("error", "Not Found");
        body.put("message", "Tópico não encontrado.");
    ...
    public ResponseEntity<String> tratarErroRegraDeNegocio() {
        return ResponseEntity.badRequest().body("Um tópico com esse título já existe");
    }
